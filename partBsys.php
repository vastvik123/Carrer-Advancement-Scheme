...
//making directories according year
//check if year directory exists, if doesn't then create directory yearwise
$temp = "users/".$email."/".$year;
$check = is_dir($temp);
echo("<br>".$temp);
echo("<br>".$check);
if(!$check){
	mkdir("users/$email/$year");
	echo("successful");
}
else{
...
if($alreadybegun==1)
{
	...
	{
	    //Setup our new file path
	    $dest =  $temp."/".$_FILES['dps1file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp. "/".$_FILES['dps2file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp. "/".$_FILES['dps3file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp."/".$_FILES['dps4file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp."/".$_FILES['dps5file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp. "/".$_FILES['dps6file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp. "/".$_FILES['dps7file']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	for($i=0;$i<sizeof($ctocourse);$i++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp. "/".$_FILES['ctofile']['name'][$i];
	...
	{	
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['ctefile']['name'][$j];
	...
	for($k=0;$k<sizeof($dara);$k++)
	{
		...
		{
		    //Setup our new file path
			$dest = $temp."/".$_FILES['darfile']['name'][$k];
	...
	{	
		...
		{
		    //Setup our new file path
		    $dest = $temp. "/".$_FILES['ecfile']['name'][$n];
	...
	{
	    //Setup our new file path
	    $dest = $temp."/".$_FILES['mtechfile']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	{
	    //Setup our new file path
	    $dest = $temp. "/".$_FILES['btechfile']['name'];
	    if(move_uploaded_file($tmpFilePath, $dest))
	    {
	...
	for($p=0;$p<sizeof($pptitle);$p++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['ppfile']['name'][$p];
	...
	for($q=0;$q<sizeof($pptitleic);$q++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['pp1file']['name'][$q];
	...
	{						
		...
		{
		    //Setup our new file path
		    $dest = $temp. "/".$_FILES['pp2file']['name'][$r];
	...
	{		
		...
		{
		    //Setup our new file path
		    $dest = $temp. "/".$_FILES['pp3file']['name'][$s];
	...
	for($t=0;$t<sizeof($ta);$t++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['research1file']['name'][$t];
	...
	for($u=0;$u<sizeof($tta);$u++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['research2file']['name'][$u];
	...
	{		
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['research3file']['name'][$v];
	...
	{		
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['cativ1file']['name'][$x];
	...
	for($y=0;$y<sizeof($cativ1_dp);$y++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['cativ2file']['name'][$y];
	...
	for($z=0;$z<sizeof($cativ2_dp);$z++)
	{
		...
		{
		    //Setup our new file path
		    $dest = $temp."/".$_FILES['cativ3file']['name'][$z];
