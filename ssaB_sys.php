...
{
	$sql1="INSERT INTO submitted_for_self_appraisal (facultyId,year,partB) VALUES ('$facultyId','$year',1)";
	$result1=mysqli_query($conn,$sql1);
}
else
{

	$sql2="UPDATE submitted_for_self_appraisal SET partB=1 WHERE facultyId='$facultyId' AND year='$year'";
