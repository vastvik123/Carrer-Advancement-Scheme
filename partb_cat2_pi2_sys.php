...
if(isset($_POST['cat2_pii2_self_a']) && $viewerId==$userId)
{
...
if(isset($_POST['cat2_pii2_hod_a']) && $_POST['cat2_pii2_hod_a']!=-1 && $hod==1)
{
...
if(isset($_POST['cat2_pii2_committee_a']) && $_POST['cat2_pii2_committee_a']!=-1 && $committee==1)
{
